...
━━━━━━━━━━━━━━━━━━━━━
🔇 *Пауза AI для контакта*
━━━━━━━━━━━━━━━━━━━━━
Чтобы отключить автоответчик для конкретного контакта (взять переписку под личный контроль), зайди в его топик и напиши:
`/mute` или `/pause` — AI замолчит, ты отвечаешь сам.
`/unmute` или `/resume` — AI снова включается.

Замолчавшие контакты помечаются 🔇 в выводе `/contacts`.
